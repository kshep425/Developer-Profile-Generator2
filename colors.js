...
let is_valid = (c) => (JSON.stringify(list_of_colors).toLowerCase().includes(c.toLowerCase())) ? true : false

let display = () => console.log(list_of_colors)

let format = (c) => c.replace(" ", "").replace("-", "")
